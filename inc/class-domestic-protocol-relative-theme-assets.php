...
if ( ! class_exists( 'Domestic_Protocol_Relative_Theme_Assets' ) ) :
	class Domestic_Protocol_Relative_Theme_Assets {
		/**
	...
	$foundationpress_protocol_relative_theme_assets = new Domestic_Protocol_Relative_Theme_Assets;
endif;
