...
function sass() {
	return buildSass( [ 'src/assets/scss/app.scss', 'src/assets/scss/gutenberg.scss' ] );
}

function sassOwlCarousel() {
	return buildSass( [ 'src/assets/owl-carousel/owl.carousel.css', 'src/assets/owl-carousel/owl.theme.default.css' ] );
}
...
function watch() {
	...
	gulp.watch( 'src/assets/js/owl-carousel/assets/*.css', sassOwlCarousel )
		.on( 'change', path => log( 'File ' + colors.bold( colors.magenta( path ) ) + ' changed.' ) )
		.on( 'unlink', path => log( 'File ' + colors.bold( colors.magenta( path ) ) + ' was removed.' ) );
}
